...
def test_authenticate_user_local(local_service, tmpdir):
...
def test_list_users_local(local_service, tmpdir):
...
def test_register_user_local(local_service, tmpdir):
...
def test_reset_password_local(local_service, tmpdir):
