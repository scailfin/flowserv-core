...
def docker_run(run_id, run_dir, state, input_files, output_files, commands, verbose):
    """Execute a list of commands synchronously using the Docker engine.
    ...
    return run_id, sync.serialize_state(state.success(files=files))
