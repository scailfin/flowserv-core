...
class TemplateArgument(ParameterBase):
    ...
    def __init__(self, parameter, value, validate=True):
        ...
        value: list or dict or scalar or robcore.core.files.InputFile
...
def mandatory_arguments(parameters, parent=None):
    ...
    Parameters
    ----------
    parameters: dict(robcore.model.template.parameter.base.TemplateParameter)
        Dictionary of parameter declarations
    parent: robcore.model.template.parameter.base.TemplateParameter
...
def parse_arguments(arguments, parameters, validate=False, parent=None):
    ...
    Returns
    -------
    dict(robcore.model.template.parameter.value.TemplateArgument)
