...
from flowserv.model.resource import ResourceDescriptor
...
class Step(object):
    ...
    def add(self, cmd):
        ...
        Returns
        -------
        flowserv.model.template.command.Step
        """
...
class PostProcessingStep(Step):
    ...
    def __init__(self, env, commands=None, mounts=None, inputs=None, outputs=None):
        ...
        inputs: list(string), optional
            ...
            as inputs
        outputs: dict(flowserv.mode.resource.ResourceDescriptor), optional
    ...
    def from_dict(doc):
        ...
        Returns
        -------
        flowserv.model.template.command.PostProcessingStep
        """
